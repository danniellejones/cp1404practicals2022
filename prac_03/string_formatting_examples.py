"""CP1404 | Prac_02 String Formatting Examples | Dannielle Jones"""
...
# Formatted string for output: 1922 Gibson L-5 CES for about $16,035!
print("{} {} for about ${:,.0f}!".format(year, name, cost))

# For loop with the range function and string formatting right alignment
